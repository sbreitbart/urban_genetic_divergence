...
# 
# car::Anova(weev_stn_gr_city_m7) #not sig - identical to model below
# car::Anova(weev_stn_gr_city_m9) #not sig
# 
# AIC(weev_stn_gr_city_m7, weev_stn_gr_city_m9) # model 9 significantly lower AIC...
# 
...
# 
# car::Anova(weev_stn_gr_usc_m7) #not sig - identical to model below
# car::Anova(weev_stn_gr_usc_m9) #not sig
# 
# AIC(weev_stn_gr_usc_m7, weev_stn_gr_usc_m9) # model 9 significantly lower AIC...
...
# 
# car::Anova(weev_stn_urbsubs_city_m7) # transect marg sig - very similar to model below
# car::Anova(weev_stn_urbsubs_city_m9) # transect marg sig 
# 
# AIC(weev_stn_urbsubs_city_m7, weev_stn_urbsubs_city_m9) # model 9 significantly higher AIC...
# 
...
# main effects
weev_stn_urbsubs_city_m7_ME <- lmer(log(scar_div_Juneheight + 0.1) ~ (1|Block) + (1|Population/Family) + City_dist + Transect_ID,
  data = weevil_both %>% filter(scar_div_Juneheight_binary == 1 & Urb_Rur == "Urban"),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
# car::Anova(weev_stn_gr_usc_m7) # nothing sig - very similar to model below
# car::Anova(weev_stn_gr_usc_m9) # nothing sig 
# 
# AIC(weev_stn_gr_usc_m7, weev_stn_gr_usc_m9) # model 9 significantly higher AIC...
# 
...
# main effects
weev_stn_gr_usc_m7_ME <- lmer(log(scar_div_Juneheight + 0.1) ~ (1|Block) + (1|Population/Family) + Urb_score + Transect_ID,
  data = weevil_both %>% filter(scar_div_Juneheight_binary == 1 & Urb_Rur == "Urban"),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
car::Anova(weev_stn_gr_city_m7) # quantitative: not sig
...
car::Anova(weev_stn_gr_usc_m7) # quantitative: not sig

```


### Urban subtransects: *Marg sig interaxn/transect for city_dist
#### City_dist
```{r}
car::Anova(weev_stn_urbsubs_city_m4) # binomial: interaxn marg sig
car::Anova(weev_stn_urbsubs_city_m7) # quantitative: transect marg sig
car::Anova(weev_stn_urbsubs_city_m7_ME) #quant main effects: transect marg sig
...
car::Anova(weev_stn_gr_usc_m7) # quantitative: not sig
car::Anova(weev_stn_gr_usc_m7_ME)
...
# 
# 
# car::Anova(weev_gr_city_m7) #not sig - very similar to model below
# car::Anova(weev_gr_city_m9) #not sig
# 
# AIC(weev_gr_city_m7, weev_gr_city_m9) # model 9 significantly lower AIC...
# 
# 
# 
...
weev_gr_usc_m10 <- lmer(log(Scar_length_cm) ~ (1|Population) + Urb_score,
  ...
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) # still singular... 
# 
# car::Anova(weev_gr_usc_m7) #not sig - very similar to model below
# car::Anova(weev_gr_usc_m9) #not sig
# 
# AIC(weev_gr_usc_m7, weev_gr_usc_m9) # model 9 significantly lower AIC...
...
# car::Anova(weev_urbsubs_city_m7) # transect sig - very similar to model below
# car::Anova(weev_urbsubs_city_m9) # transect sig
# 
# AIC(weev_urbsubs_city_m7, weev_urbsubs_city_m9) # model 9 significantly higher AIC...
# 
...
# main effects
weev_urbsubs_city_m7_ME <- lmer(log(Scar_length_cm + 0.1) ~ (1|Block) + (1|Population/Family) + City_dist + Transect_ID,
  data = weevil_both %>% filter(Scar_length_cm_binary == 1 & Urb_Rur == "Urban"),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
# car::Anova(weev_urbsubs_usc_m7) # transect sig - very similar to model below
# car::Anova(weev_urbsubs_usc_m9) # transect marginally sig
# 
# AIC(weev_urbsubs_usc_m7, weev_urbsubs_usc_m9) # model 9 significantly higher AIC...
# 
...
# main effects
weev_urbsubs_usc_m7_ME <- lmer(log(Scar_length_cm + 0.1) ~ (1|Block) + (1|Population/Family) + Urb_score + Transect_ID,
  data = weevil_both %>% filter(Scar_length_cm_binary == 1 & Urb_Rur == "Urban"),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
car::Anova(weev_gr_city_m7) # quantitative: not sig
...
car::Anova(weev_gr_usc_m7) # quantitative: not sig
...
car::Anova(weev_urbsubs_city_m7) # quantitative: transect sig
car::Anova(weev_urbsubs_city_m7_ME) # quantitative main effects: transect sig

AIC(weev_urbsubs_city_m7, weev_urbsubs_city_m7_ME)# main effects lower AIC (more than 2)
...
car::Anova(weev_urbsubs_usc_m7) # quantitative: transect sig
car::Anova(weev_urbsubs_usc_m7_ME) # quantitative main effects: transect sig

AIC(weev_urbsubs_usc_m7, weev_urbsubs_usc_m7_ME)# main effects lower AIC (more than 2)

summary(weev_urbsubs_usc_m7)
...
# car::Anova(herb2020.S_gr_dist_m8) # identical to anova below
# car::Anova(herb2020.S_gr_dist_m10)
# 
# AIC(herb2020.S_gr_dist_m8, herb2020.S_gr_dist_m10) # not-singular model has lower AIC
...
herb2020.S_gr_usc_m9 <- lmer(log(Herbivory.Sept_mean) ~  (1|Population/Family) + Urb_score,
  data = herbivory_both_2020 %>% filter(Herbivory.Sept_mean_binary == 1),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) # still singular... remove Pop/Fam instead

herb2020.S_gr_usc_m10 <- lmer(log(Herbivory.Sept_mean) ~ (1|Block) + Urb_score,
  data = herbivory_both_2020 %>% filter(Herbivory.Sept_mean_binary == 1),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
sjPlot::plot_model(herb2020.S_gr_usc_m10, type='diag') # looks good

car::Anova(herb2020.S_gr_usc_m8) # identical to anova below
car::Anova(herb2020.S_gr_usc_m10)

AIC(herb2020.S_gr_usc_m8, herb2020.S_gr_usc_m10) # not-singular model has lower AIC
...
herb2020.S_urb_dist_m9 <- lmer(log(Herbivory.Sept_mean) ~  (1|Population/Family) + City_dist * Transect_ID,
  data = herbivory_both_2020 %>% filter(Herbivory.Sept_mean_binary == 1),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5))) # still singular... try removing Pop/Fam

herb2020.S_urb_dist_m10 <- lmer(log(Herbivory.Sept_mean) ~ (1|Block) + City_dist * Transect_ID,
  data = herbivory_both_2020 %>% filter(Herbivory.Sept_mean_binary == 1),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
sjPlot::plot_model(herb2020.S_urb_dist_m10, type='diag') # looks good 

car::Anova(herb2020.S_urb_dist_m8) # identical to ANOVA below
car::Anova(herb2020.S_urb_dist_m10)

AIC(herb2020.S_urb_dist_m8, herb2020.S_urb_dist_m10) # m10 >4 lower AIC


# main effects
herb2020.S_urb_dist_m8_ME <- lmer(log(Herbivory.Sept_mean) ~ (1|Block) + (1|Population/Family) + City_dist + Transect_ID,
  data = herbivory_both_2020 %>% filter(Herbivory.Sept_mean_binary == 1),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
herb2020.S_urb_usc_m10 <- lmer(log(Herbivory.Sept_mean) ~ (1|Block) + Urb_score * Transect_ID,
  data = herbivory_both_2020 %>% filter(Herbivory.Sept_mean_binary == 1),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
sjPlot::plot_model(herb2020.S_urb_usc_m10, type='diag') # looks good 

car::Anova(herb2020.S_urb_usc_m8) # identical to ANOVA below
car::Anova(herb2020.S_urb_usc_m10)

AIC(herb2020.S_urb_usc_m8, herb2020.S_urb_usc_m10) # m10 >4 lower AIC
...
# main effects
herb2020.S_urb_usc_m8_ME <- lmer(log(Herbivory.Sept_mean) ~ (1|Block) + (1|Population/Family) + Urb_score + Transect_ID,
  data = herbivory_both_2020 %>% filter(Herbivory.Sept_mean_binary == 1),
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
car::Anova(herb2020.S_gr_dist_m8) # quantitative: not sig
...
car::Anova(herb2020.S_gr_usc_m8) # quantitative: not sig
...
car::Anova(herb2020.S_urb_dist_m8) # quantitative: nothing sig
car::Anova(herb2020.S_urb_dist_m8_ME) # quantitative main effects: not sig

AIC(herb2020.S_urb_dist_m8, herb2020.S_urb_dist_m8_ME)
# main effects has lower AIC
...
car::Anova(herb2020.S_urb_usc_m8) # quantitative: nothing sig
car::Anova(herb2020.S_urb_usc_m8_ME) # quantitative main effects: not sig

AIC(herb2020.S_urb_usc_m8, herb2020.S_urb_usc_m8_ME)
# main effects has lower AIC
```
...
rgr_gr_city_m2 <- lmer(rel_growth_rate ~  (1|Population/Family) + City_dist,
  data = heights_both_2020, REML = F)
sjPlot::plot_model(rgr_gr_city_m2, type = "diag") # still singular... take out Pop/Fam

rgr_gr_city_m3 <- lmer(rel_growth_rate ~ (1|Block) + City_dist,
  data = heights_both_2020, REML = F)
sjPlot::plot_model(rgr_gr_city_m3, type = "diag") # not singular. looks normal except for left tail (but otherwise looks fine... I think it's kurtotic)..

car::Anova(rgr_gr_city_m1) # identical to anova below
car::Anova(rgr_gr_city_m3)

AIC(rgr_gr_city_m1, rgr_gr_city_m3) # m3 has 4 AIC lower
...
rametsJ_urbsubs_urbsubs_m4 <- glmer(Ramets_June ~ (1|Block) +(1|Population) + (1|ID) + Urb_score * Transect_ID,
  data = heights_both_2020 %>% filter(Urb_Rur == "Urban"),
  family = poisson,
  control=glmerControl(optimizer="bobyqa",
                            optCtrl=list(maxfun=2e5))) # singular... take out block

rametsJ_urbsubs_urbsubs_m5 <- glmer(Ramets_June ~ (1|Population) + (1|ID) + Urb_score * Transect_ID,
  data = heights_both_2020 %>% filter(Urb_Rur == "Urban"),
  family = poisson,
  control=glmerControl(optimizer="bobyqa",
...
# car::Anova(rametsJ_urbsubs_urbsubs_m1) # very similar results to below model! Urb_score is sig and transect is marg sig
# car::Anova(rametsJ_urbsubs_urbsubs_m4)
# 
# AIC(rametsJ_urbsubs_urbsubs_m1, rametsJ_urbsubs_urbsubs_m4) # m4 6 AIC below m1
# 

# main effects
rametsJ_urbsubs_urbsubs_m1_ME <- glmer(Ramets_June ~ (1|Block) + (1|Population/Family) + Urb_score + Transect_ID,
  data = heights_both_2020 %>% filter(Urb_Rur == "Urban"),
  family = poisson,
  control=glmerControl(optimizer="bobyqa",
                            optCtrl=list(maxfun=2e5)))
...
##### Urb_score
```{r}
car::Anova(rametsJ_urbsubs_urbsubs_m1) # urb_score sig and transect marg sig
car::Anova(rametsJ_urbsubs_urbsubs_m1_ME) # urb_score sig and transect marg sig

AIC(rametsJ_urbsubs_urbsubs_m1, rametsJ_urbsubs_urbsubs_m1_ME) # ME has lower aic but <2
