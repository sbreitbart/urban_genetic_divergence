...
car::Anova(weev_stn_urbsubs_city_m6) #nothing sig
car::Anova(weev_stn_urbsubs_city_m7) #nothing sig
...
##### City_dist
```{r}
car::Anova(weev_stn_urbsubs_city_m4) # binomial: not sig
car::Anova(weev_stn_urbsubs_city_m7) # quantitative: not sig
car::Anova(weev_stn_urbsubs_city_m7_ME)
