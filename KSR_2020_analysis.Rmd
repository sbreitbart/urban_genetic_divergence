...
# Do Hellinger transformations
herb2020_July.hel <- vegan::decostand(herb2020_July, "hellinger")
herb2020_Aug.hel <- vegan::decostand(herb2020_Aug, "hellinger")
# Distances
herb_July.DHell = dist(herb2020_July.hel)
herb_Aug.DHell = dist(herb2020_Aug.hel)

# make PCNM df
library(PCNM)
dist_Jul=dist(herb2020_July)
herb2020_July.PCNM=pcnm(dist_Jul)





# Redundancy analysis- ATTEMPT 1
result_Jul_varpart = varpart(herb2020_July,
                             ~ City_dist,
                             herb2020_July.PCNM,
                             data=herb2020_July.env,
                             transfo="hel")
# Keep getting this error: Error in colMeans(x, na.rm = TRUE) : 'x' must be numeric
# So trying this:
sapply(herb2020_July, class)
sapply(herb2020_July.PCNM, class)
sapply(herb2020_July.env, class)
# Everything is numeric except for Vectors within PCNM list...

showvarparts(3, bg=2:4)
plot(result_Jul_varpart, bg=5:7)
...
# ATTEMPT 2: do Hellinger transformations, bind ID and env'tl cols, then do RDA like I'd been trying before
herb_July_hel_bind <- bind_cols(herb2020_July.env, herb2020_July.hel)





rda_herb_July <- rda(herb_July_hel_bind %>%
                       # removing mean_monarch_quantity_past b/c all zeroes
                        dplyr::select(, c(5:14)) ~ herb_July_hel_bind$City_dist,
                na.action = "na.omit",
                scale = T)
...
# Purpose: initial ordination on herbivore data
## Make herbivore subsets per month
### JULY
#### All sites
herb2020_July <- herbivores2020_popmeans %>%
...
## Herbivory
NOTE: I originally fit these models w/herbivory scores ranging from 0 to 100 and used lmer. Then I switched to herbivory percents (dividing by 100) and using binomial distr. I would've used quasi-binomial but glmer can't handle that, only glm.
-The story DID change when analyzing the
 -JULY
  -Entire gradient w/city_dist (NOT urb_score):
   -With lmer, herbivory DID change with urbanization when quantified with city_dist. With glmer, it's not significant.
  -Urban subs w/city_dist:
   -With lmer, herbivory DID change with urb when quantified w/city_dist. With glmer, it's not sig.
### July
#### glmer
##### Entire gradient: *Not sig for either
###### City_dist
...
NOTE:  Originally used lmer but then switched to glmer w/poisson bc it's count data.
-This didn't change the story for gradient (city_dist nor urb_score)
-This DID change story for urb subs (city_dist: transect lost marg sig, and urb_score: transect lost sig)
##### Entire gradient: *NOT sig for city_dist or urb_score
###### City_dist
```{r}
# NO DIFFERENCE BETWEEN MODELS W/ CROSSED VS NESTED RANDOM EFFECTS #
...
### NESTED RANDOM EFFECTS-----
glmer(Ramets_midJune ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist,
  data = heights_19_20, family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5)))
# singular

car::Anova(glmer(Ramets_midJune ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist,
  data = heights_19_20, family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5))))
# distance NOT significant
...
r.squaredGLMM(glmer(Ramets_midJune ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist,
  data = heights_19_20, family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5))))
...
### NESTED RANDOM EFFECTS-----
glmer(Ramets_midJune ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score,
  data = heights_19_20, family = poisson)
# singular

car::Anova(glmer(Ramets_midJune ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score,
  data = heights_19_20, family = poisson))
# nothing significant


r.squaredGLMM(glmer(Ramets_midJune ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score,
  data = heights_19_20, family = poisson))
...
### NESTED RANDOM EFFECTS-----
# Full model
glmer(Ramets_midJune  ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson)
# singular

car::Anova(glmer(Ramets_midJune  ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson))
# nothing significant
...
AIC(glmer(Ramets_midJune  ~ (1|Block) + (1|Year) + (1|Population:Family) + City_dist * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson))
...
### NESTED RANDOM EFFECTS-----
# Full model
glmer(Ramets_midJune  ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5)))
# singular

car::Anova(glmer(Ramets_midJune  ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5))))
# nothing significant
...
AIC(glmer(Ramets_midJune  ~ (1|Block) + (1|Year) + (1|Population:Family) + Urb_score * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson))
...
#### glmer
NOTE:  Originally used lmer but then switched to glmer w/poisson bc it's count data.
-This didn't change the story for gradient NOR urb_score (city_dist nor urb_score)
##### Entire gradient: *Not sig for either
###### City_dist
```{r}
# NO DIFFERENCE BETWEEN MODELS W/ CROSSED VS NESTED RANDOM EFFECTS #
...
### NESTED RANDOM EFFECTS-----
glmer(Ramets_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist,
  data = heights_19_20, family = poisson)
#  singular

car::Anova(glmer(Ramets_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist,
  data = heights_19_20, family = poisson))
# distance not significant
...
r.squaredGLMM(glmer(Ramets_Sept ~ (1|Block) + (1|Year) + (1|Population:Family) + City_dist,
  data = heights_19_20, family = poisson))
...
### NESTED RANDOM EFFECTS-----
glmer(Ramets_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score,
  data = heights_19_20, family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5)))
#  singular...

car::Anova(glmer(Ramets_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score,
  data = heights_19_20, family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5))))
# not significant
...
r.squaredGLMM(glmer(Ramets_Sept ~ (1|Block) + (1|Year) + (1|Population:Family) + Urb_score,
  data = heights_19_20, family = poisson))
...
### NESTED RANDOM EFFECTS-----
# Full model
glmer(Ramets_Sept  ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5)))
# singular

car::Anova(glmer(Ramets_Sept  ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5))))
# nothing significant
...
AIC(glmer(Ramets_Sept  ~ (1|Block) + (1|Year) + (1|Population:Family) + City_dist * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson,
     control=glmerControl(optimizer="bobyqa",
                                 optCtrl=list(maxfun=2e5))))
...
### NESTED RANDOM EFFECTS-----
# Full model
glmer(Ramets_Sept  ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson)
# singular

car::Anova(glmer(Ramets_Sept  ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson))
# nothing significant
...
AIC(glmer(Ramets_Sept  ~ (1|Block) + (1|Year) + (1|Population:Family) + Urb_score * Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), family = poisson))
...
# GLMER
car::Anova(glmer(Herbivory_mean_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist,
  data = herbivory_19_20, family = binomial(link = logit)))
# nothing is significant though p-val lower
...
car::Anova(glmer(Herbivory_mean_Sept ~ (1|Block) + (1|Year) + (1|Population:Family) + City_dist,
  data = herbivory_19_20, family = binomial(link = logit)))
# distance not significant though p-val lower
...
# GLMER
car::Anova(glmer(Herbivory_mean_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score,
  data = herbivory_19_20, family = binomial(link = logit)))
# dist significant now
...
# GLMER
car::Anova(glmer(Herbivory_mean_Sept  ~ (1|Block) + (1|Year) + (1|Population/Family) + City_dist * Transect_ID,
     data = herbivory_19_20 %>% dplyr::filter(., Transect_ID != "Rural"),
     family = binomial(link = logit)))
# distance significant now
...
# GLMER
car::Anova(glmer(Herbivory_mean_Sept  ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score * Transect_ID,
     data = herbivory_19_20 %>% dplyr::filter(., Transect_ID != "Rural"),
     family = binomial(link = logit)))
# nothing significant
