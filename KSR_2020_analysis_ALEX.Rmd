...
### Sept height- HAVEN'T FIXED DIAGNOSTICS YET 2/16
#### lmer: diagnostics
```{r}
# Gradient / city_dist----------
...
# main effects:
height2_urb_dist_m2_ME <- lmer(sqrt(Total_Height_Sept)  ~ (1|Block) + (1|Year) +(1|Population/Family) + City_dist + Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), REML = F,
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
# main effects:
height2_urb_usc_m2_ME <- lmer(sqrt(Total_Height_Sept)  ~ (1|Block) + (1|Year) +(1|Population/Family) + Urb_score + Transect_ID,
     data = heights_19_20 %>% dplyr::filter(., Transect_ID != "Rural"), REML = F,
  control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
```
...
herbivory_19_20[,"FamPop"] <- paste0(herbivory_19_20$Family,herbivory_19_20$Population,sep="-")

herbivory_gr_dist_m2 <- glmer(Herbivory_mean_Sept ~ (1|Block) + (1|Year) + City_dist,
  data = herbivory_19_20,
  family = "binomial",
  control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))

summary(herbivory_gr_dist_m2)
...
# main effects:
herbivory_urb_dist_m2_ME <- glmer(Herbivory_mean_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) +  City_dist + Transect_ID,
    data = herbivory_19_20 %>% dplyr::filter(., Transect_ID != "Rural"),
    family = binomial,
  control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
...
# main effects:
herbivory_urb_usc_m2_ME <- glmer(Herbivory_mean_Sept ~ (1|Block) + (1|Year) + (1|Population/Family) + Urb_score + Transect_ID,
    data = herbivory_19_20 %>% dplyr::filter(., Transect_ID != "Rural"),
    family = binomial,
  control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=2e5)))
```
