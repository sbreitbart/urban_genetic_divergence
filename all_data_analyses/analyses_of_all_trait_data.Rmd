...
```{r}
 ...
 word_export <- read_docx()
  ...
  body_add_par(word_export, value = "All populations & Urbanization = Distance from City Center")
  body_add_flextable(word_export, flextable(all_pvalues_Q1))
  
  body_add_par(word_export, value = "")
  body_add_par(word_export, value = "")
  
  body_add_par(word_export, value = "All populations & Urbanization = Urbanization Score")
  body_add_flextable(word_export, flextable(all_pvalues_Q1_u))
  
  body_add_par(word_export, value = "")
  body_add_par(word_export, value = "")
  
  body_add_par(word_export, value = "Urban populations & Urbanization = Distance from City Center")
  body_add_flextable(word_export, flextable(all_pvalues_Q2))
  
  body_add_par(word_export, value = "")
  body_add_par(word_export, value = "")
  
  body_add_par(word_export, value = "Urban populations & Urbanization = Urbanization Score")
  body_add_flextable(word_export, flextable(all_pvalues_Q2_u))

  print(word_export, here::here("./All_data_analyses/FDR_p_all.docx"))
```
