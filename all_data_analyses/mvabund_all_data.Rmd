...
# (Intercept)                                                     
# Urb_Rur       2.382  0.785          0  1.000        0.193  0.994
#             herb_l_bin        herb_l_quant        weev_mods_bin
#                F value Pr(>F)      F value Pr(>F)       F value
# (Intercept)                                                    
# Urb_Rur              0  1.000            0  1.000             0
#                    weev_mods_quant           ldmc            sla
#             Pr(>F)         F value Pr(>F) F value Pr(>F) F value
# (Intercept)                                                     
# Urb_Rur      1.000           1.386  0.948       0  1.000       0
#                    heights_early        heights_late       
#             Pr(>F)       F value Pr(>F)      F value Pr(>F)
# (Intercept)                                                
# Urb_Rur      1.000         0.244  0.994        0.361  0.994
#                 rgr        ramets_early        ramets_late       
#             F value Pr(>F)      F value Pr(>F)     F value Pr(>F)
# (Intercept)                                                      
# Urb_Rur       0.003  0.994        0.449  0.994       0.608  0.994
#             mortality         flsucc        flowers         flsize
#               F value Pr(>F) F value Pr(>F) F value Pr(>F) F value
# (Intercept)                                                       
# Urb_Rur             0  1.000   5.273  0.268       0  1.000       0
#                     fltime        flstart           pods       
#             Pr(>F) F value Pr(>F) F value Pr(>F) F value Pr(>F)
# (Intercept)                                                    
# Urb_Rur      1.000   0.888  0.988       0  1.000    0.31  0.994
#             peduncles        X6.6_main        X15_main       
#               F value Pr(>F)   F value Pr(>F)  F value Pr(>F)
# (Intercept)                                                  
# Urb_Rur         0.252  0.994     0.317  0.994    0.738  0.993
#             X17.6_main          total       
#                F value Pr(>F) F value Pr(>F)
# (Intercept)                                 
# Urb_Rur          0.578  0.994   0.528  0.994
# 
...
#             F value Pr(>F)    F value Pr(>F)      F value Pr(>F)
# (Intercept)                                                     
# Urb_Rur       0.126  1.000          0  1.000        0.298  0.999
#             herb_l_bin        herb_l_quant        weev_mods_bin
#                F value Pr(>F)      F value Pr(>F)       F value
# (Intercept)                                                    
# Urb_Rur              0  1.000            0  1.000             0
...
#             Pr(>F)         F value Pr(>F) F value Pr(>F) F value
# (Intercept)                                                     
# Urb_Rur      1.000           0.292  0.999       0  1.000       0
#                    heights_early        heights_late            rgr
#             Pr(>F)       F value Pr(>F)      F value Pr(>F) F value
# (Intercept)                                                        
# Urb_Rur      1.000         0.026  1.000        0.008  1.000   0.034
#                    ramets_early        ramets_late        mortality
#             Pr(>F)      F value Pr(>F)     F value Pr(>F)   F value
# (Intercept)                                                        
# Urb_Rur      1.000        0.007  1.000       0.007  1.000         0
#                     flsucc        flowers         flsize       
#             Pr(>F) F value Pr(>F) F value Pr(>F) F value Pr(>F)
# (Intercept)                                                    
# Urb_Rur      1.000   4.901  0.337       0  1.000       0  1.000
#              fltime        flstart           pods        peduncles
#             F value Pr(>F) F value Pr(>F) F value Pr(>F)   F value
# (Intercept)                                                       
# Urb_Rur       0.079  1.000       0  1.000   0.059  1.000     0.002
#                    X6.6_main        X15_main        X17.6_main
#             Pr(>F)   F value Pr(>F)  F value Pr(>F)    F value
# (Intercept)                                                   
# Urb_Rur      1.000     0.317  0.999    0.738  0.995      0.578
#                      total       
#             Pr(>F) F value Pr(>F)
# (Intercept)                      
# Urb_Rur      0.998   0.528  0.998
# 
# Arguments: with 999 resampling iterations using residual (without replacement) resampling and uncorrelated response (for faster computation) 
