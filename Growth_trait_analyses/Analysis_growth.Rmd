...
# take out fam- NOT CONVERGING with poisson (can't use nbinom2 w/glmer) unless I add nagq = 0
...
tidy(ramets_e_ranova.fam) # Family: p ~ 0.288
...
tidy(ramets_l_ranova.fam) # Family: p ~ 0.122
...
tidy(surv_ranova.fam) # Family: p ~ 0.883
...
tidy(ramets_e_ranova.fam) # Family: p ~ 0.113
...
tidy(ramets_l_ranova.fam) # Family: p ~ 0.0886
...
tidy(surv_ranova.fam) # Family: p ~ 0.0908
