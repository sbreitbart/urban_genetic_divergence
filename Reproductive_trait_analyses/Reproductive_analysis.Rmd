...
fl_per_infl_mods , # mean flowers per inflorescence
...
#### mean flowers per inflorescence
```{r}
## Best
### City_dist
fl_per_infl_mods_best_c <- fl_per_infl_mods[c(1,4)]

### Urb_score
fl_per_infl_mods_best_u <- fl_per_infl_mods[c(2,6)]

## Alt
### City_dist
fl_per_infl_mods_alt_c <- fl_per_infl_mods[3]

### Urb_score
fl_per_infl_mods_alt_u <- fl_per_infl_mods[5]
```
...
#### City_dist
```{r}
make_all_anovas_tidy(fl_per_infl_mods_best_c) %>%
  save_as_image(., path = here::here("./Reproductive_trait_analyses/Figures/ANOVA/Best_models/MeanFlowersPerInflor_citydist.png"))
```

#### Urb_score
```{r}
make_all_anovas_tidy(fl_per_infl_mods_best_u) %>%
  save_as_image(., path = here::here("./Reproductive_trait_analyses/Figures/ANOVA/Best_models/MeanFlowersPerInflor_urbscore.png"))
```

### Alternative Models
#### City_dist
```{r}
make_all_anovas_tidy_altmods(fl_per_infl_mods_alt_c) %>%
  save_as_image(., path = here::here("./Reproductive_trait_analyses/Figures/ANOVA/Alt_models/MeanFlowersPerInflor_citydist_alt.png"))
```

#### Urb_score
```{r}
make_all_anovas_tidy_altmods(fl_per_infl_mods_alt_u) %>%
  save_as_image(., path = here::here("./Reproductive_trait_analyses/Figures/ANOVA/Alt_models/MeanFlowersPerInflor_urbscore_alt.png"))
```
