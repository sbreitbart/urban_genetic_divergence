...
## City_dist / urban subtransects
peduncles_urbsubs_city1, # Best model
peduncles_urbsubs_city1_ME, # Qualitatively identical model (<2 AIC away)

## Urbanization score  / urban subtransects
peduncles_urbsubs_usc1, # Best model
peduncles_urbsubs_usc1_ME # Qualitatively identical model (<2 AIC away)
