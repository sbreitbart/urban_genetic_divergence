...
##### City_dist
```{r}
# doesn't converge unless I remove year specifically
...
flsize_gr_city1 <- glmmTMB(Overall_mean^2 ~
                             Block +
                             Year +
                             (1|Population/Family) +
                             City_dist, 
...
#### Urb_score
```{r}
flsize_gr_usc1 <- glmmTMB(Overall_mean^2 ~
                             Block +
                             Year +
                             (1|Population/Family) +
                             Urb_score, 
...
#### City_dist
```{r}
flsize_urbsubs_city1 <- glmmTMB(Overall_mean^2 ~
                             Block +
                             Year +
                             (1|Population/Family) +
                             City_dist * Transect_ID, 
...
## MAIN EFFECTS
flsize_urbsubs_city1_ME <- glmmTMB(Overall_mean^2 ~
                             Block +
                             Year +
                             (1|Population/Family) +
                             City_dist + Transect_ID, 
...
#### Urb_score
```{r}
# doesn't converge unless transformed and year removed
flsize_urbsubs_usc1 <- glmmTMB(Overall_mean^2 ~
                             Block +
                            # Year +
                             (1|Population/Family) +
                             Urb_score * Transect_ID, 
...
## MAIN EFFECTS
## lots of trouble making this converge, but I think it's moot because interaction is highly sig in full model
# flsize_urbsubs_usc1_ME <- glmmTMB(Overall_mean^2 ~
#                             # Block +
#                             # Year +
#                              (1|Population/Family) +
#                              Urb_score + Transect_ID, 
...
# doesn't converge with year included
