...
# Flowering time-----
None of these truly converge, even with nagq = 0
# 2020-----
...
# Date of first follicle-----
# 2020 (only 20 rows- not doing)-----

# only 20 entries for urban sites- not enough for parametric test
...
# 2022-----
firstpod_ranova3 <- glmer(Julian_first_follicle^3 ~
                               Block +
                               (1|Population) +
                               (1|Population:Fam_uniq),
                             data = flowering %>%
...
pb_ranova_transects(firstpod_ranova3,
          ...
          "./Reproductive_trait_analyses/Tables/Ranova/Date_first_follicle_2022_transects.docx")
