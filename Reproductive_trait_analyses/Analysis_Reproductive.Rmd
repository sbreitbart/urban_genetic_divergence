...
# Flowers/plant-----
# 2020-----
flowers_ranova1 <- glmer.nb(total_flower_count ~
                               Block +
                               (1|Population) +
                               (1|Population:Family),
                             data = flowering %>%
...
pb_ranova(flowers_ranova1,
          "Flower count: 2020",
          "./Reproductive_trait_analyses/Tables/Ranova/flowercount_2020.docx")

# 2021-----
flowers_ranova2 <- glmer.nb(total_flower_count ~
                               Block +
                               (1|Population) +
                               (1|Population:Family),
                             data = flowering %>%
...
pb_ranova(flowers_ranova2,
          "Flower count: 2021",
          "./Reproductive_trait_analyses/Tables/Ranova/flowercount_2021.docx")


# 2022-----
flowers_ranova3 <- glmer.nb(total_flower_count ~
                               Block +
                               (1|Population) +
                               (1|Population:Family),
                             data = flowering %>%
...
# 2020-----
firstpod_ranova1 <- glmer(Julian_first_follicle ~
                               Block +
                               (1|Population) +
                               (1|Population:Family),
                             data = flowering %>%
...
pb_ranova(firstpod_ranova1,
          "First follicle: 2020",
          "./Reproductive_trait_analyses/Tables/Ranova/first_pods_2020.docx")


# 2021-----
firstpod_ranova2 <- glmer(Julian_first_follicle ~
                               Block +
                               (1|Population) +
                               (1|Population:Family),
                             data = flowering %>%
...
pb_ranova(firstpod_ranova2,
          "First follicle: 2021",
          "./Reproductive_trait_analyses/Tables/Ranova/first_pods_2021.docx")

# 2022-----
firstpod_ranova3 <- glmer(Julian_first_follicle ~
                               Block +
                               (1|Population) +
                               (1|Population:Family),
                             data = flowering %>%
