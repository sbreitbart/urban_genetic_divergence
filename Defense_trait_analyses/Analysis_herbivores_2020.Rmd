...
# URBANIZATION SCORE
# m2_AA <- glmmTMB(Aphis_asclepiadis ~
#               Block + (1|Population/Family) + (1|Sample) +
#               Urb_score,
#               data = herbivores,
#               family = poisson)
...
# URBANIZATION SCORE
# m2_AA.urb <- glmmTMB(Aphis_asclepiadis ~
#               Block + (1|Population/Family) + (1|Sample) +
#               Urb_score * Transect_ID,
#               data = herbivores %>% 
#                 filter(., Transect_ID != "Rural"),
...
# URBANIZATION SCORE
# m2_MA <- glmmTMB(Myzocallis_asclepiadis ~
#               Block + (1|Population/Family) + (1|Sample) +
#               Urb_score,
#               data = herbivores,
#               family = poisson)
...
plot(res)
 Outlier test has a p = 0.04 but I'm not going to worry about that.
...
```{r}
# DISTANCE FROM CITY CENTER
# m1_EE.urb <- glmmTMB(Euchaetes_egle ~
#               Block + (1|Population/Family) + (1|Sample) +
#               City_dist * Transect_ID,
#               data = herbivores %>% 
#                 filter(., Transect_ID != "Rural"),
...
# URBANIZATION SCORE
# m2_EE.urb <- glmmTMB(Euchaetes_egle ~
#               Block + (1|Population/Family) + (1|Sample) +
#               Urb_score * Transect_ID,
#               data = herbivores %>% 
#                 filter(., Transect_ID != "Rural"),
...
```{r}
# DISTANCE FROM CITY CENTER
# m1_LK.urb <- glmmTMB(Lygaeus_kalmii ~
#               Block + (1|Population/Family) + (1|Sample) +
#               City_dist * Transect_ID,
#               data = herbivores %>% 
#                 filter(., Transect_ID != "Rural"),
...
# URBANIZATION SCORE
# m2_LK.urb <- glmmTMB(Lygaeus_kalmii ~
#               Block + (1|Population/Family) + (1|Sample) +
#               Urb_score * Transect_ID,
#               data = herbivores %>% 
#                 filter(., Transect_ID != "Rural"),
...
##### JUST TRYING OUT glmmTMB/POISSON MODEL TO SEE IF ANY DIFFERENCE- NOPE
# FULL MODEL:
m1_LK.urb
# NOT singular
...
plot(res)
.. try neg bin transf just in case
...
# URBANIZATION SCORE
m2_LC <- glmmTMB(Labidomera_clivicollis ~
              Block + (1|Population/Family) + (1|Sample) +
              Urb_score,
              data = herbivores,
              family = poisson,
...
```{r}
# DISTANCE FROM CITY CENTER
# m1_LC.urb <- glmmTMB(Labidomera_clivicollis ~
#               Block + (1|Population/Family) + (1|Sample) +
#               City_dist * Transect_ID,
#               data = herbivores %>% 
#                 filter(., Transect_ID != "Rural"),
...
# URBANIZATION SCORE
m2_LC.urb <- glmmTMB(Labidomera_clivicollis ~
              Block + (1|Population/Family) + (1|Sample) +
              Urb_score * Transect_ID,
              data = herbivores %>% 
                filter(., Transect_ID != "Rural"),
...
# main effects
m2_LC.urb_ME <- glmmTMB(Labidomera_clivicollis ~
              Block + (1|Population/Family) + (1|Sample) +
              Urb_score + Transect_ID,
              data = herbivores %>% 
                filter(., Transect_ID != "Rural"),
...
r.squaredGLMM(glmmTMB(Rhyssomatus_lineaticollis ~
              Block + (1|Population/Family) + (1|Sample) +
              City_dist + Transect_ID,
              data = herbivores %>% 
                filter(., Transect_ID != "Rural"),
...
AIC(m1_RL.urb)
AIC(glmmTMB(Rhyssomatus_lineaticollis ~
              Block + (1|Population/Family) + (1|Sample) +
              City_dist + Transect_ID,
              data = herbivores %>% 
                filter(., Transect_ID != "Rural"),
