...
herb_early_binary_random_LM <- glmmTMB(estimate ~ 
                            City_dist,
                          data = blup_pops_herb_early_bin)

performance::check_model(herb_early_binary_random_LM) # looks ok
summary(herb_early_binary_random_LM) # not working
car::Anova(herb_early_binary_random_LM) # not working
r.squaredGLMM(herb_early_binary_random_LM) # R2m = 0.08
...
# simpler linear model- convergence issue
herb_early_binary_fixed_LM <- glmmTMB(estimate ~ 
                            City_dist,
                          data = blup_pops_herb_early_bin)

performance::check_model(herb_early_binary_fixed_LM) # looks ok
summary(herb_early_binary_fixed_LM) # not working
car::Anova(herb_early_binary_fixed_LM) # not working
...
# simpler linear model- convergence issue
herb_late_binary_random_LM <- glmmTMB(estimate ~ 
                            City_dist,
                          data = blup_pops_herb_late_bin)

performance::check_model(herb_late_binary_random_LM) # looks ok
summary(herb_late_binary_random_LM) # not working
car::Anova(herb_late_binary_random_LM) # not working
...
> Between models, can't compare p-values due to convergence issues. Marginal R-square value of population-level model is ~50x higher than plant-level model (R2m(LM) = 0.01).
>
...
# simpler linear model- convergence issue
herb_late_binary_fixed_LM <- glmmTMB(estimate ~ 
                            City_dist,
                          data = blup_pops_herb_late_bin)

performance::check_model(herb_late_binary_fixed_LM) # looks ok
summary(herb_late_binary_fixed_LM) # not working
car::Anova(herb_late_binary_fixed_LM) # not working
r.squaredGLMM(herb_late_binary_fixed_LM) # R2m = 0.01

```

#### Conclusion

> Can't compare p-values between models but marginal R-square value of plant-level model is ~3x lower than population-level model (R2m(LM) = 0.01).
>
