...
ggplot(monarch_gradient_01_pred) +
  ...
  labs(x = "Distance to Urban Center (km)",
       y = expression(paste("Abundance: ", italic(" Danaus plexippus")))) +
  ylim(NA, 0.85) +
  theme_1() +
...
ggplot(asclepiadis_gradient_01_pred) +
  ...
  rep_geoms +
  labs(x = "Distance to Urban Center (km)",
       y = expression(paste("Abundance: ", italic(" Liriomyza asclepiadis")))) +
  ylim(1.5, 3) +
  theme_1() +
...
ggplot(clivicollis_gradient_01_pred) +
  ...
  rep_geoms +
  labs(x = "Distance to Urban Center (km)",
       y = expression(paste("Abundance: ", italic(" Liriomyza clivicollis")))) +
  ylim(-1, 1) +
  theme_1() +
