...
tidy(monarch_ranova.pop) # Pop: p = 0.51

# variance
get_pve(monarch_ranova.pop) # 2.807
...
tidy(monarch_ranova.fam) # Fam: p ~ 0.441

# variance
get_pve(monarch_ranova.fam) # 8.132
...
asclepiadis_ranova.pop <- PBmodcomp(full, reduced,
          nsim = 1000,
          cl = makeCluster(6))
tidy(asclepiadis_ranova.pop) #  p ~ 0.899

# variance
get_pve(asclepiadis_ranova.pop) # 31.412
...
asclepiadis_ranova.fam <- PBmodcomp(full, reduced,
          nsim = 1000,
          cl = makeCluster(6))
tidy(asclepiadis_ranova.fam) # Fam: p ~ 0.713

# variance
get_pve(asclepiadis_ranova.fam) # 53.893
...
tidy(clivicollis_ranova.pop) #  p ~ 0.581

# variance
get_pve(clivicollis_ranova.pop) # 4.857
...
tidy(clivicollis_ranova.fam) # Fam: p ~ 0.611

# variance
get_pve(clivicollis_ranova.fam) # 10.389
...
tidy(monarch_ranova.pop) # Pop: p ~ 0.0376

# variance
get_pve(monarch_ranova.pop) # 1.468
...
tidy(monarch_ranova.fam) # Family: p ~ 0.0168
...
tidy(asclepiadis_ranova.pop) # Pop: p ~ 0.846

# variance
get_pve(asclepiadis_ranova.pop) # 34.65
...
# variance
get_pve(asclepiadis_ranova.fam) # 54.868
...
tidy(clivicollis_ranova.pop) # Pop: p ~ 0.00244

# variance
get_pve(clivicollis_ranova.pop) # 18.067
