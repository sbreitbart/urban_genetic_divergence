...
# L. clivicollis-----
compare_anovas(
  update(clivicollis_mods_best_c[[1]], .~. - City_dist),
  herbivores,
  "2021",
  "Labidomera clivicollis abundance",
  "./Defense_trait_analyses/Tables/Comparing_ANOVA/clivicollis.docx")
...
# L. clivicollis-----
compare_anovas_transects(
  update(clivicollis_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  herbivores,
  "2021",
  "Labidomera clivicollis abundance",
  "./Defense_trait_analyses/Tables/Comparing_ANOVA/clivicollis_transects.docx")
