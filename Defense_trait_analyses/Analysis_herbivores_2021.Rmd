...
# take out fam
# test city_dist
full <- glmer.nb(Monarch_Quantity_Observed ~
                                Block +
                                (1|Population) +
                              Year +
                               Sample +
...
tidy(monarch_ranova.pop) # Pop: p = 0.443

# variance
get_pve(monarch_ranova.pop) # 0.508
...
tidy(monarch_ranova.fam) # Fam: p ~ 1

# variance
get_pve(monarch_ranova.fam) # NA bc singular
...
# test city_dist
# test pop
full <- glmer.nb(Liriomyza_asclepiadis ~
                                Block +
                                (1|Population) +
                                 Year +
                                Sample +
...
asclepiadis_ranova.pop <- PBmodcomp(full, reduced,
          nsim = 1000,
          cl = makeCluster(6))
tidy(asclepiadis_ranova.pop) #  p ~ 0.894

# variance
get_pve(asclepiadis_ranova.pop) # 4.602
...
asclepiadis_ranova.fam <- PBmodcomp(full, reduced,
          nsim = 1000,
          cl = makeCluster(6))
tidy(asclepiadis_ranova.fam) # Fam: p ~ 0.674

# variance
get_pve(asclepiadis_ranova.fam) # 11.37
...
# test city_dist
# test pop
full <- glmer.nb(Labidomera_clivicollis ~
                                Block +
                                (1|Population) +
                                Year +
                                Sample +
...
tidy(clivicollis_ranova.pop) #  p ~ 1

# variance
get_pve(clivicollis_ranova.pop) # NA bc singular
...
tidy(clivicollis_ranova.fam) # Fam: p ~ 0.664

# variance
get_pve(clivicollis_ranova.fam) # NA bc singular
...
tidy(monarch_ranova.pop) # Pop: p ~ 0.0305

# variance
get_pve(monarch_ranova.pop) # NA bc singular
...
tidy(monarch_ranova.fam) # Family: p ~ 0.0305

# variance
get_pve(monarch_ranova.fam) # singular so can't compute


## test transect-----
test_tr <- glmer.nb(Monarch_Quantity_Observed ~
                 Block + Year + Sample +
...
tidy(asclepiadis_ranova.pop) # Pop: p ~ 0.858

# variance
get_pve(asclepiadis_ranova.pop) # 5.948
...
# variance
get_pve(asclepiadis_ranova.fam) # 14.491



## test transect-----
test_tr <- glmer.nb(Liriomyza_asclepiadis ~
                 Block + Year + Sample +
                (1|Population/Family) + Transect_ID,
                              data = herbivores %>%
                dplyr::filter(Transect_ID != "Rural"),
...
tidy(clivicollis_ranova.pop) # Pop: p ~ 0.0166
...
full <- glmer.nb(Labidomera_clivicollis ~
                Block + 
                  Year + 
               #   Sample +
               #   if I don't remove a fixed effect, the p-value is 0, which doesn't make sense
                (1|Population/Family) + City_dist,
                              data = herbivores %>%
                dplyr::filter(Transect_ID != "Rural"),
             nAGQ=0,
...
# variance
get_pve(clivicollis_ranova.fam) # can't compute- is singular


## test transect-----
test_tr <- glmer.nb(Labidomera_clivicollis ~
                Block + Year + Sample +
                (1|Population/Family) + Transect_ID,
                              data = herbivores %>%
                dplyr::filter(Transect_ID != "Rural"),
