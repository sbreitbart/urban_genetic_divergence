...
# Latex-----
latex_ranova_mod1 <- lmer(Latex_weight_mg ~
                            Block +
                            (1|Population/Family),
                        data = latex,
                        REML = T)

ranova(latex_ranova_mod1)
...
herbiv_e_quant_ranova_mod1 <- lmer(Herbivory_mean_early ~
                                Block +
                               (1|Population/Family),
                              data = herbivory %>%
                        dplyr::filter(
...
herbiv_e_quant_ranova1 <- CreateRanovaOutput(herbiv_e_quant_ranova_mod1, "Herbivory, before flowering, 2020: Quantitative") %T>%
  flextable::save_as_html(.,
                        path = here::here("./Defense_trait_analyses/Tables/Ranova/herbivory_early_quant_2020.html"))
...
herbiv_e_quant_ranova1 <- CreateRanovaOutput(herbiv_e_quant_ranova_mod1, "Herbivory, before flowering, 2021: Quantitative") %T>%
  flextable::save_as_html(.,
                        path = here::here("./Defense_trait_analyses/Tables/Ranova/herbivory_early_quant_2021.html"))

# Herbivory (after flowering) (quantitative)-------
herbiv_l_quant_ranova_mod1 <- lmer(Herbivory_mean_late ~
                                Block +
                               (1|Population/Family),
                              data = herbivory %>%
                        dplyr::filter(
...
herbiv_l_quant_ranova1 <- CreateRanovaOutput(herbiv_l_quant_ranova_mod1, "Herbivory, after flowering, 2020: Quantitative") %T>%
  flextable::save_as_html(.,
                        path = here::here("./Defense_trait_analyses/Tables/Ranova/herbivory_late_quant_2020.html"))
...
herbiv_l_quant_ranova1 <- CreateRanovaOutput(herbiv_l_quant_ranova_mod1, "Herbivory, after flowering, 2021: Quantitative") %T>%
  flextable::save_as_html(.,
                        path = here::here("./Defense_trait_analyses/Tables/Ranova/herbivory_late_quant_2021.html"))


# Weevil scar length (quantitative)-----
weev_quant_ranova_mod1 <- lmer(Scar_length_cm ~
                                    Block +
                                   (1|Population/Family), 
                              data = weevil %>%
...
weev_q_ranova1 <- CreateRanovaOutput(weev_quant_ranova_mod1, "Weevil Damage: Quantitative, 2020") %T>%
  flextable::save_as_html(.,
                        path = here::here("./Defense_trait_analyses/Tables/Ranova/weevil_quant_2020.html"))



weev_quant_ranova_mod1 <- lmer(Scar_length_cm ~
                                    Block +
                                   (1|Population/Family),                               data = weevil %>%
                                dplyr::filter(Scar_length_cm > 0 &
                                                Year == 2021),
                              REML = T)


weev_q_ranova1 <- CreateRanovaOutput(weev_quant_ranova_mod1, "Weevil Damage: Quantitative, 2021") %T>%
  flextable::save_as_html(.,
                        path = here::here("./Defense_trait_analyses/Tables/Ranova/weevil_quant_2021.html"))
```
...
full_fixed <- glm(Herbivory_mean_early_binary ~
                    Population +
                    Fam_uniq,
                              data = herbivory %>%
                dplyr::filter(Year == 2020),
...
pb_ranova(full,
          ...
          "./Defense_trait_analyses/Tables/Ranova/new_herbiv_e_bin_2020.docx")
...
pb_ranova(full,
          ...
          "./Defense_trait_analyses/Tables/Ranova/new_herbiv_e_bin_2021.docx")
...
pb_ranova(full,
          ...
          "./Defense_trait_analyses/Tables/Ranova/new_herbiv_l_bin_2020.docx")
...
pb_ranova(full,
          ...
          "./Defense_trait_analyses/Tables/Ranova/new_herbiv_l_bin_2021.docx")
