...
#### Urb_score
```{r}
ltx_gr_usc_m1 <- glmmTMB(Latex_weight_mg ~ Block + (1|Population/Family) + Urb_score,
                        data = latex,
                        REML = F)
...
# performance::check_model(update(ltx_gr_usc_m1, . ~ Block + (1|Population:Fam_uniq) + Urb_score)) 
# 
# # there is a diff (qualitatively identical though). So use Pop/Fam. P < 0.01 in both cases
# car::Anova(ltx_gr_usc_m1)
# car::Anova(update(ltx_gr_usc_m1, . ~ Block + (1|Fam_uniq) + Urb_score))
...
#### City_dist
```{r}
# ltx_urbsubs_city_m1 <- glmmTMB(Latex_weight_mg ~ Block + (1|Population/Family) + City_dist * Transect_ID,
#                         data = latex %>%
#                           dplyr::filter(Transect_ID != "Rural"),
#                         REML = F)
# 
...
# 
# # use fam_uniq, see if anything changes
# performance::check_model(update(ltx_urbsubs_city_m1, Latex_weight_mg^(1/2) ~ Block + (1|Population:Fam_uniq) + City_dist* Transect_ID)) 
# 
# # there is a diff (qualitatively identical though). So use Pop/Fam
# ## interaxn not sig, so use type II SS
# car::Anova(update(ltx_urbsubs_city_m1, Latex_weight_mg^(1/2) ~ Block + (1|Population/Family) + City_dist* Transect_ID), type = "III")
# car::Anova(update(ltx_urbsubs_city_m1, Latex_weight_mg^(1/2) ~ Block + (1|Fam_uniq) + City_dist* Transect_ID), type = "III")
# 
# ## interaxn not sig, so use type II SS
# car::Anova(update(ltx_urbsubs_city_m1, Latex_weight_mg^(1/2) ~ Block + (1|Population/Family) + City_dist* Transect_ID), type = "II")
# car::Anova(update(ltx_urbsubs_city_m1, Latex_weight_mg^(1/2) ~ Block + (1|Fam_uniq) + City_dist* Transect_ID), type = "II")

# final model
ltx_urbsubs_city_m1 <- glmmTMB(sqrt(Latex_weight_mg) ~ Block + (1|Population/Family) + City_dist * Transect_ID,
                        data = latex %>%
                          dplyr::filter(Transect_ID != "Rural"),
                        REML = F)
...
# MAIN EFFECTS MODEL
# ltx_urbsubs_city_m2 <- glmmTMB(Latex_weight_mg ~ Block + (1|Population/Family) + City_dist + Transect_ID,
#                         data = latex %>%
#                           dplyr::filter(Transect_ID != "Rural"),
#                         REML = F)
# 
...
# 
# # use fam_uniq, see if anything changes
# performance::check_model(update(ltx_urbsubs_city_m2, Latex_weight_mg^(1/2) ~ Block + (1|Population:Fam_uniq) + City_dist + Transect_ID)) 
# 
# # there is a diff (qualitatively identical though). So use Pop/Fam
# car::Anova(update(ltx_urbsubs_city_m2, Latex_weight_mg^(1/2) ~ .), type = "II")
# car::Anova(update(ltx_urbsubs_city_m2, Latex_weight_mg^(1/2) ~ Block + (1|Fam_uniq) + City_dist + Transect_ID), type = "II")


# final ME model
ltx_urbsubs_city_m2 <- glmmTMB(sqrt(Latex_weight_mg) ~ Block + (1|Population/Family) + City_dist + Transect_ID,
                        data = latex %>%
                          dplyr::filter(Transect_ID != "Rural"),
                        REML = F)
...
#### Urb_score
```{r}
# ltx_urbsubs_usc_m1 <- glmmTMB(Latex_weight_mg ~ Block + (1|Population/Family) + Urb_score * Transect_ID,
#                         data = latex %>%
#                           dplyr::filter(Transect_ID != "Rural"),
#                         REML = F)
# 
...
# 
# # use fam_uniq, see if anything changes
# performance::check_model(update(ltx_urbsubs_usc_m1, Latex_weight_mg^(1/2) ~ Block + (1|Population:Fam_uniq) + Urb_score* Transect_ID)) 
# 
# # there is a diff (qualitatively identical though). So use Pop/Fam
# ## interaxn sig for both
# car::Anova(update(ltx_urbsubs_usc_m1, Latex_weight_mg^(1/2) ~ Block + (1|Population/Family) + Urb_score* Transect_ID), type = "III")
# car::Anova(update(ltx_urbsubs_usc_m1, Latex_weight_mg^(1/2) ~ Block + (1|Fam_uniq) + Urb_score* Transect_ID), type = "III")


# final model
ltx_urbsubs_usc_m1 <- glmmTMB(sqrt(Latex_weight_mg) ~ Block + (1|Population/Family) + Urb_score * Transect_ID,
                        data = latex %>%
                          dplyr::filter(Transect_ID != "Rural"),
                        REML = F)
...
# MAIN EFFECTS MODEL
# ltx_urbsubs_usc_m2 <- glmmTMB(Latex_weight_mg ~ Block + (1|Population/Family) + Urb_score + Transect_ID,
#                         data = latex %>%
#                           dplyr::filter(Transect_ID != "Rural"),
#                         REML = F)
# 
...
# 
# # use fam_uniq, see if anything changes
# performance::check_model(update(ltx_urbsubs_usc_m2, Latex_weight_mg^(1/2) ~ Block + (1|Population:Fam_uniq) + Urb_score + Transect_ID)) 
# 
# # there is a diff (qualitatively identical though). So use Pop/Fam
# car::Anova(update(ltx_urbsubs_usc_m2, Latex_weight_mg^(1/2) ~ .), type = "II")
# car::Anova(update(ltx_urbsubs_usc_m2, Latex_weight_mg^(1/2) ~ Block + (1|Fam_uniq) + Urb_score + Transect_ID), type = "II")


# final ME model
ltx_urbsubs_usc_m2 <- glmmTMB(sqrt(Latex_weight_mg) ~ Block + (1|Population/Family) + Urb_score + Transect_ID,
                        data = latex %>%
                          dplyr::filter(Transect_ID != "Rural"),
                        REML = F)
...
```{r}
# OLD DIAGNOSTICS-----
# herbiv_e_gr_dist_m1 <- glmmTMB(Herbivory_mean_early ~ Block + Year + (1|Population/Family) + City_dist,
#                               data = herbivory,
...
#   glmmTMB(Herbivory_mean_early^(1/3) ~ Block + Year + (1|Population/Family) + City_dist,
#                               data = herbivory,
#           ziformula = ~1,
#                               REML = F)
...
# 
# performance::check_model(
#   glmmTMB(early_levels ~ Year + Block + (1|Population/Family) + City_dist,
#                               data = herbivory,
...
# test1 <- glmmTMB(Herbivory_mean_early_recode  ~ Block + Year + (1|Population/Family) + City_dist,
#                                 data = herbivory,
...
```{r}
# OLD DIAGNOSTICS-----
# herbiv_e_gr_usc_m1 <- glmmTMB(Herbivory_mean_early ~ Block + Year + (1|Population/Family) + Urb_score,
#                               data = herbivory,
#                               REML = F) 
# 
...
# 
# performance::check_model(
#   glmmTMB(Herbivory_mean_early^(1/3) ~ Block + Year + (1|Population/Family) + Urb_score,
#                               data = herbivory,
#           ziformula = ~1,
#                               REML = F)
# ) # still some heavy tails but looks better
...
# # try bins
# performance::check_model(
#   glmmTMB(early_levels ~ Year + Block + (1|Population/Family) + Urb_score,
#                               data = herbivory,
#                                REML = F)) # very bimodal residuals
# 
# 
...
# 
# # TRY BETA FAMILY
# test1 <- glmmTMB(Herbivory_mean_early_recode  ~ Block + Year + (1|Population/Family) + Urb_score,
#                                 data = herbivory,
#                                 family = beta_family(link="logit"),
#                                REML = F)
# performance::check_model(test1) # heavy right tail
...
```{r}
# OLD DIAGNOSTICS-----
# herbiv_e_urbsubs_dist_m1 <- glmmTMB(Herbivory_mean_early ~ Block + Year + (1|Population/Family) + City_dist * Transect_ID,
#                               data = herbivory %>%
#                                 dplyr::filter(Transect_ID != "Rural"),
#                               REML = F) # convergence issue. Try taking out block
# 
# 
# performance::check_model(glmmTMB(Herbivory_mean_early ~  Year + (1|Population/Family) + City_dist * Transect_ID,
#                               data = herbivory %>%
#                                 dplyr::filter(Transect_ID != "Rural")),
#                               REML = F) # very right-skewed. try sqrt transformation
# 
# 
# performance::check_model(glmmTMB(Herbivory_mean_early^(1/2) ~  Year + (1|Population/Family) + City_dist * Transect_ID,
#                               data = herbivory %>%
#                                 dplyr::filter(Transect_ID != "Rural")),
#                               REML = F) # better but still very right-skewed. try cube root transformation
# 
# 
# performance::check_model(glmmTMB(Herbivory_mean_early^(1/3) ~  Year + (1|Population/Family) + City_dist * Transect_ID,
#                               data = herbivory %>%
#                                 dplyr::filter(Transect_ID != "Rural")),
#                               REML = F) # better. Put back block, see if it runs
# 
# performance::check_model(glmmTMB(Herbivory_mean_early^(1/3) ~ Block + Year + (1|Population/Family) + City_dist * Transect_ID,
#                               data = herbivory %>%
#                                 dplyr::filter(Transect_ID != "Rural")),
#                               REML = F) # doesn't run
# 
...
# plot(DHARMa::simulateResiduals(glmmTMB(Herbivory_mean_early_recode  ~  Year + (1|Population/Family) + City_dist * Transect_ID,
#                                 data = herbivory %>%
#                                 dplyr::filter(Transect_ID != "Rural"),
#                                 family = beta_family(link="logit"),
