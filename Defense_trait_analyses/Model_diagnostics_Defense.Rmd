...
# gxe_test_latex1 <- glmmTMB(Latex_weight_mg ~
#                             Block*Fam_uniq ,
#                         data = latex,
#                         REML = F)
# 
# 
# performance::check_model(gxe_test_latex1)
# plot(DHARMa::simulateResiduals(gxe_test_latex1))
# car::Anova(gxe_test_latex1)
...
# # test for gxe intxns- won't converge with Block*Fam or Block*Pop, even when I take out other vars
# gxe_test_herb_quant_e <- glmmTMB(log(Herbivory_mean_early) ~
#                             Block*Population ,
#                         data = herbivory %>%
#                         dplyr::filter(
#                           Herbivory_mean_early_binary == 1),
...
# 
# 
# performance::check_model(gxe_test_herb_quant_e)
# plot(DHARMa::simulateResiduals(gxe_test_herb_quant_e))
# car::Anova(gxe_test_herb_quant_e)
```
