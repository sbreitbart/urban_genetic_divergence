...
### Urb_score
herb_e_bin_mods_best_u <- herb_early_mods_binomial[c(2,6)]

## Alt
### City_dist
herb_e_bin_mods_alt_c <- herb_early_mods_binomial[4]

### Urb_score
herb_e_bin_mods_alt_u <- herb_early_mods_binomial[5]
...
tidy(herbiv_e_ranova.pop) # Pop: p ~ 0.04
...
#### City_dist
```{r}
make_all_anovas_tidy_altmods(herb_e_bin_mods_alt_c) %>%
  save_as_image(., path = here::here("./Defense_trait_analyses/Figures/ANOVA/Alt_models/herb_e_bin_citydist_alt.png"))
```
