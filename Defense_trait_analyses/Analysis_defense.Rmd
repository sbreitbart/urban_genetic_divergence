...
tidy(weev_ranova.pop) # Pop: p ~ 0.29
...
tidy(weev_ranova.fam) # Family: p ~ 0.51
...
tidy(weev_ranova.pop) # Pop: p ~ 0.73
...
# SLA
sla_ranova_mod1
h2_sla <- Calc_narrow_sense_h(0.000  ,
                    0.000  ,
                    11.524  ) %T>%
  print()
...
# Latex
latex_ranova_mod1
h2_latex <- Calc_narrow_sense_h(1.549,
                    1.193,
                    5.243) %T>%
  print()

# Weevil damage: quantitative
weev_quant_ranova_mod1
h2_weev_quant <- Calc_narrow_sense_h(0.13744 ,
                    0.07537 ,
                    0.60462 ) %T>%
  print()


# not sure how to find heritability for bootstrapped models
```
...
# SLA
sla_ranova_mod1
qst_sla <- Calc_qst(0.000  ,
                    0.000 ) %T>%
  print()

# Latex
latex_ranova_mod1
qst_latex <- Calc_qst(1.549,
                    1.193) %T>%
  print()

# Weevil damage: quantitative
weev_quant_ranova_mod1
qst_weev_quant <- Calc_qst(0.13744 ,
                    0.07537) %T>%
  print()


# not sure how to find qst for bootstrapped models
```
