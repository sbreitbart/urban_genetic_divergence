...
NOTES:
-Jan 2020: Revamped data (imported as "Data") to include all 2019 data. Haven't adapted code in this notebook for it because it might be moot... planning on just importing it into the 2020 rmd and combining it with 2020 so I can compare each year's data.
...
```{r, import}
Data <- read.csv(
  here::here("./CommonGardenExperiment_2019Data/clean_data/2019_allvars_clean.csv"), 
  header=T,
