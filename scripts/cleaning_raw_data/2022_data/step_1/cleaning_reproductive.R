...
reproductive <- read.csv(here::here(
  "./CommonGardenExperiment_2022Data/raw_data/2022_FloralTraits_final.csv"),
  header=T,
...
reproductive %<>%
  dplyr::mutate(.,
         Flowered2022 = ifelse(is.na(reproductive$Flower_count_I1) == TRUE,
                               0,
                               1)) %>%
  dplyr::mutate(.,
         Flowered2022 = as.factor(Flowered2022))

unique(reproductive$Flowered2022)


# Make subset of only flowering plants
flowering_2022 <- reproductive %>%
...
flowering_2022 <- flowering_2022 %>% rowwise() %>%
...
write.csv(reproductive,
          here::here("./data/CommonGardenExperiment_2022Data/partially_cleaned_data/2022_reproductive_partialclean.csv"))
write.csv(flowering_2022,
          here::here("./data/CommonGardenExperiment_2022Data/partially_cleaned_data/2022_floweringplants_partialclean.csv"))
