...
#-------------------
# at end of season 
survival <- read.csv(here::here("./data/CommonGardenExperiment_2021Data/raw_data/2021_DC5_Herbivory_Survival_final.csv"),
...
#-------------------
write.csv(survival,
          here::here("./data/CommonGardenExperiment_2021Data/partially_cleaned_data/2021_survival_partialclean.csv"))
