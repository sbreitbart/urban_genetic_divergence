...
compare_anovas(
  ...
  "2022",
  "Flowering success",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flsucc.docx")
...
compare_anovas(
  ...
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flowers.docx")
...
compare_anovas(
  ...
  "2022",
  "Flower size",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flsize.docx")
...
compare_anovas(
  ...
  "2022",
  "Flowering duration",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/fltime.docx")
...
compare_anovas(
  ...
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flstart.docx")

# Pollinaria removed-----
compare_anovas(
  update(poll_mods_best_c[[1]], .~. - City_dist),
  flowering,
  "2022",
  "Pollinaria removed",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/pollinaria.docx")
...
compare_anovas(
  ...
  "2022",
  "Follicles",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/pods.docx")


# Date of first pod-----
## I'm subbing Julian_first_follicle-170 with Julian_first_follicle-200 because it doesn't converge with 170
compare_anovas(
  update(first_pods_mods_best_c[[1]], Julian_first_follicle-200~. - City_dist),
  flowering,
  "2022",
  "Date of first follicle",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/firstpod.docx")
...
compare_anovas(
  ...
  "2022",
  "Inflorescences",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/peduncles.docx")
```
...
compare_anovas_transects(
  update(flsucc_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  reproduc,
  "2022",
  "Flowering success",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flsucc_transects.docx")

# Mean flowers/inflors-----
compare_anovas_transects(
  update(flowers_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Flowers per inflorescences",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flowers_transects.docx")


# Flower size-----
compare_anovas_transects(
  update(flsize_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Flower size",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flsize_transects.docx")


# Flowering time-----
compare_anovas_transects(
  update(fltime_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Flowering duration",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/fltime_transects.docx")


# Flowering start-----
compare_anovas_transects(
  update(flstart_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Date of first flower",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/flstart_transects.docx")

# Pods-----
compare_anovas_transects(
  update(poll_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Pollinaria removed",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/pollinaria_transects.docx")


# Pods-----
compare_anovas_transects(
  update(pods_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Follicles",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/pods_transects.docx")


# Date of first pod-----
compare_anovas_transects(
  update(first_pods_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Date of first follicle",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/firstpod_transects.docx")


# Peduncles-----
compare_anovas_transects(
  update(peduncles_mods_best_c[[2]], .~. - City_dist*Transect_ID),
  flowering,
  "2022",
  "Inflorescences",
  "./Figures_Tables/Comparing_ANOVA/Reproduction/peduncles_transects.docx")
```