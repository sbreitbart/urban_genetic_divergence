...
# this isn't working
# library(XML)
# rawHTML <- XML::readHTMLTable("Figures_Tables/ranova_PVE/Defense/latex.html",
#            # header = c("Variable",
#            #            "Group",
#            #            "Variance",
#            #            "PVE",
...
pve <- read.csv(here::here("./Figures_Tables/ranova_PVE/Defense/pve_defense_Q1.csv")) %>%
...
compare_anovas(
  ...
  "2021",
  "Herbivory before flowering (binary)",
  "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_early_binary.docx")
...
filepath <- "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_early_quant.docx"
last_year <- "2021"
...
compare_anovas(
  ...
  "2021",
  "Herbivory after flowering (binary)",
  "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_late_binary.docx")

# herbivory after flowering (quantitative)-----

var_name <- "Herbivory after flowering (quantitative)"
filepath <- "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_late_quant.docx"
last_year <- "2021"
...
compare_anovas(
  ...
  "2021",
  "Weevil damage (binary)",
  "./Figures_Tables/Comparing_ANOVA/Defense/Weevil_damage_binary.docx")

# weevil damage (quantitative)-----

var_name <- "Weevil damage (quantitative)"
filepath <- "./Figures_Tables/Comparing_ANOVA/Defense/Weevil_damage_quant.docx"
last_year <- "2021"
...
compare_anovas_transects(
  ...
  "2021",
  "Herbivory before flowering (binary)",
  "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_early_binary_transects.docx")

# herbivory before flowering (quantitative)-----
## doing this and other quant mods manually b/c I need to filter the dataset to exclude zeroes

var_name <- "Herbivory before flowering (quantitative)"
filepath <- "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_early_quant_transects.docx"
last_year <- "2021"
...
compare_anovas_transects(
  ...
  "2021",
  "Herbivory after flowering (binary)",
  "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_late_binary_transects.docx")

# herbivory after flowering (quantitative)-----

var_name <- "Herbivory after flowering (quantitative)"
filepath <- "./Figures_Tables/Comparing_ANOVA/Defense/herbivory_late_quant_transects.docx"
last_year <- "2021"
...
compare_anovas_transects(
  ...
  "2021",
  "Weevil damage (binary)",
  "./Figures_Tables/Comparing_ANOVA/Defense/Weevil_damage_binary_transects.docx")

# weevil damage (quantitative)-----

var_name <- "Weevil damage (quantitative)"
filepath <- "./Figures_Tables/Comparing_ANOVA/Defense/Weevil_damage_quant_transects.docx"
last_year <- "2021"
