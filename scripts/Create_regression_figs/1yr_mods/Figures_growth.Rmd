...
grow.tr.m4_ggpred <- update(grow.tr.m4,
         heights_l_cuberoot ~ .)
...
heights_late_urbsubs_01_pred <- ggeffects::ggpredict(grow.tr.m4_ggpred,
                                   terms = c("City_dist", "Transect_ID"),
                                   type = "fe") %>%
  as.data.frame()
...
### Gradient
```{r}
heights$rgr_cuberoot <- (heights$rel_growth_rate)^(1/3)*100
...
# city_dist
grow.m5 # CUBE ROOT transformed x 100
...
# urb_score
grow.m5_u # CUBE ROOT transformed x 100
...
grow.tr.m5_ggpred <- make_1yrmod_transects(
  update(rgr_mods_best_c[[2]],
         rgr_cuberoot ~ .),
  "2021", heights)

grow.tr.m5_u_ggpred <- make_1yrmod_transects(
...
# city_dist
grow.tr.m5 # CUBE ROOT transformed x 100
...
# urb_score
grow.tr.m5_u # CUBE ROOT transformed x 100
...
ggpred_Q1.citydist_rgr <- ggplot(rgr_gradient_01_pred) +
  rep_geoms +
  labs(x = "Distance to Urban Center (km)",
       y = expression(paste("Relative growth rate" ^{1/3}, "x 100"))) +
  ylim(19, 23) +
  theme_1() +
#   # adding stats from ANOVA
           ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.08,
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(ldmc_mods_best_c[[2]]) %>%
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(sla_mods_best_c[[2]]) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m3) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m4) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.79,
                    label = paste0(" D x S: p = ", tidy_anova(grow.tr.m4) %>%
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m5) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m6) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.79,
                    label = paste0(" D x S: p = ", tidy_anova(grow.tr.m6) %>%
dplyr::filter(Predictor == "Distance to City Center x Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m7) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.79,
                    label = paste0(" D x S: p = ", tidy_anova(grow.tr.m7) %>%
dplyr::filter(Predictor == "Distance to City Center x Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m8) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5) 
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(ldmc_mods_best_u[[2]]) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(sla_mods_best_u[[2]]) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m3_u) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m4_u) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m5_u) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m6_u) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m7_u) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
size = 4.5) +
  ggpp::geom_text_npc(aes(npcx = 0.05, npcy = 0.88,
                    label = paste0(" Subransect: p = ", tidy_anova(grow.tr.m8_u) %>%
dplyr::filter(Predictor == "Subtransect") %>%
dplyr::select(p))),
size = 4.5)
...
```{r}
ggarrange(
addborder(ggpred_Q1.citydist_ldmc, "growth"),
addborder(ggpred_Q1.citydist_sla, "growth"),
addborder(ggpred_Q1.citydist_height_e, "growth"),
addborder(ggpred_Q1.citydist_height_l, "growth"),
addborder(ggpred_Q1.citydist_rgr, "growth"),
addborder(ggpred_Q1.citydist_ramets_e, "growth"),
addborder(ggpred_Q1.citydist_ramets_l, "growth"),
addborder(ggpred_Q1.citydist_mortality, "growth") +
  font("x.text"),
          ncol = 4,
          nrow = 2,
          align = "hv",
...
```{r}
ggarrange(
addborder(ggpred_Q1.urbscore_ldmc, "growth"),
addborder(ggpred_Q1.urbscore_sla, "growth"),
addborder(ggpred_Q1.urbscore_height_e, "growth"),
addborder(ggpred_Q1.urbscore_height_l, "growth"),
addborder(ggpred_Q1.urbscore_rgr, "growth"),
addborder(ggpred_Q1.urbscore_ramets_e, "growth"),
addborder(ggpred_Q1.urbscore_ramets_l, "growth"),
addborder(ggpred_Q1.urbscore_mortality, "growth") +
            font("x.text"),
          ncol = 4,
          nrow = 2,
          align = "hv",
...
```{r}
ggarrange(
 addborder(ggpred_Q2.citydist_ldmc, "growth"),
 addborder(ggpred_Q2.citydist_sla, "growth"),
 addborder(ggpred_Q2.citydist_height_e, "growth"),
 addborder(ggpred_Q2.citydist_height_l, "growth"),
 addborder(ggpred_Q2.citydist_rgr, "growth"),
 addborder(ggpred_Q2.citydist_ramets_e, "growth"),
 addborder(ggpred_Q2.citydist_ramets_l, "growth"),
 addborder(ggpred_Q2.citydist_mortality, "growth") +
            font("x.text"),
          ncol = 4,
          nrow = 2,
          align = "hv",
...
```{r}
ggarrange(
  addborder(ggpred_Q2.urbsubs_ldmc, "growth"),
  addborder(ggpred_Q2.urbsubs_sla, "growth"),
  addborder(ggpred_Q2.urbsubs_height_e, "growth"),
  addborder(ggpred_Q2.urbsubs_height_l, "growth"),
  addborder(ggpred_Q2.urbsubs_rgr, "growth"),
  addborder(ggpred_Q2.urbsubs_ramets_e, "growth"),
  addborder(ggpred_Q2.urbsubs_ramets_l, "growth"),
  addborder(ggpred_Q2.urbsubs_mortality, "growth") +
            font("x.text"),
          ncol = 4,
          nrow = 2,
          align = "hv",
