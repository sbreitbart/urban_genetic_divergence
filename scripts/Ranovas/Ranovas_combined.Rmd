...
ran1$Population_p <- ifelse(ran1$Population_p == "<0.001",
                        ran1$Population_p,
                        round(as.numeric(ran1$Population_p), 3))


ran1$Family_p <- ifelse(ran1$Family_p == "<0.001",
                        ran1$Family_p,
                        round(as.numeric(ran1$Family_p), 3))
```
