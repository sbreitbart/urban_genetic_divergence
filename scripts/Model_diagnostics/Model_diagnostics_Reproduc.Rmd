...
# # test for gxe
# gxe_test_poll <- glmmTMB(sqrt(mean_poll)~
#                            Block*City_dist +
#                            Year +
#                            (1|Population/Family),
#                          data = flowering,
#                          REML = F)
# 
# test_gxe(poll_gr_city1, gxe_test_poll) # stat equiv
# car::Anova(poll_gr_city1)
# car::Anova(gxe_test_poll) # block*city marg sig at p = 0.09, otherwise identical
# 
# # compare ranovas
# # have to use lmer instead of glmmtmb- ranova can't use glmmtmb- otherwise identical models
# # GxE MOD
# ranova(lmer(sqrt(mean_poll) ~
#                                Block*City_dist +
#                                Year +
#                                (1|Population/Family) +
#                                City_dist,
#                               data = flowering,
#                                REML = F))
# # p(Population) = 1. p(Family) = 7.885e-05 
# 
# # REG MOD
# ranova( lmer(sqrt(mean_poll) ~
#                                         Block +
...
#                               data = flowering,
#              REML = F))
# # p(Population) = 1. p(Family) = 8.793e-05
# #
# # p-values for both mods nearly identical, so I'll keep using regular model.
```
...
# # test for gxe
# gxe_test_poll2 <- glmmTMB(sqrt(mean_poll)~
#                            Block*Urb_score +
#                            Year +
#                            (1|Population/Family),
#                          data = flowering)
# 
# test_gxe(poll_gr_city1, gxe_test_poll2) # reg mod best
```
...
# # test for gxe
# gxe_test_poll3 <- glmmTMB(sqrt(mean_poll)~
#                            Block*City_dist +
#                            Year +
#                             Transect_ID*City_dist +
#                            (1|Population/Family),
...
#                            dplyr::filter(Transect_ID != "Rural"))
# 
# test_gxe(poll_urbsubs_city1, gxe_test_poll3) # reg mod best
```
...
# # test for gxe
# gxe_test_poll4 <- glmmTMB(sqrt(mean_poll)~
#                            Block*Urb_score +
#                            Year +
#                             Transect_ID*Urb_score +
#                            (1|Population/Family),
...
#                            dplyr::filter(Transect_ID != "Rural"))
# 
# test_gxe(poll_urbsubs_usc1 , gxe_test_poll4) # reg mod best
```
