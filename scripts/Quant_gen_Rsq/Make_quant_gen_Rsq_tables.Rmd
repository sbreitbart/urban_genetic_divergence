...
### 2021 Herbivores (same as multi-year mods so leaving empty)
### Growth
```{r}
# LDMC-----
update(
...
make_full_R2_table(
  ...
  save_as_docx(path = here::here("./Figures_Tables/Rsquared/Rsquared_all.docx"),
...
## 1-year models
Not doing for cardenolides or 2021 herbivores because same as multi-year mods
### Reproduction
```{r}
