...
poll_mods_reml_T  <-lapply(
  list(repr.m9, repr.m9_u, repr.tr.m9, repr.tr.m9_u),
  make_1yrmod_REML_repr2)
...
make_full_R2_table <- function(list1, list2, list3,
  ...
  dplyr::mutate(Variable = case_when(
    ...
    add_row(
      # adding the clivicollis row this way because otherwise this function breaks when I try to add it, not sure why
