...
# URBANIZATION SCORE
m2_RL <- glmer(Rhyssomatus_lineaticollis ~
              (1|Block) + (1|Population/Family) + (1|Sample) +
              Urb_score,
              data = herbivores,
              family = poisson,
...
plot(res)
# several issues.. try neg bin transf

m2_RL.nb <- glmmTMB(Rhyssomatus_lineaticollis ~
              (1|Block) + (1|Population/Family) + (1|Sample) +
              Urb_score,
              data = herbivores ,
              family = nbinom1(),
              REML = F)
res <- simulateResiduals(m2_RL.nb)
plot(res)
# Looks better but still doesn't pass KS test and dispersion deviates...


# My data does only contain 20 non-zero data points out of 1683...
