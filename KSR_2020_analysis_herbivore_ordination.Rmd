...
## Make functions
```{r}
Anova_etc.dist <- function(full_model_dist, main_effects_model_dist) {

    A_citydist <- list(
      print(paste('Full model ANOVA: ', formula(full_model_dist)), quote = FALSE),
      print(car::Anova(full_model_dist)),
    
      print('Full model R-squared: ', quote = FALSE),
      print(r.squaredGLMM(full_model_dist)),
  
      print(paste('Main effects model ANOVA: ', formula(main_effects_model_dist)), quote = FALSE),
      print(car::Anova(main_effects_model_dist)),
        
      print('Main effects model R-squared: ', quote = FALSE),
      print(r.squaredGLMM(main_effects_model_dist)),
    
      cat(sep="\n\n"),
    
      print(paste("AIC (full model) =", AIC(full_model_dist)), quote = FALSE),
      print(paste("AIC (main effects model) =", AIC(main_effects_model_dist)), quote = FALSE)
      
  )
  
  # make filename a string (from symbol)
  filename1 <- toString(formula(full_model_dist)[[2]])

 # export list to csv named for herbivore
  lapply(A_citydist, function(x) write.table( data.frame(x),
                                              file = paste(filename1, "_ANOVA_citydist.csv"),
                                              append= T, sep=',' ))

}
Anova_etc.urbscore <- function(full_model_urbscore, main_effects_model_urbscore) {
  
  A_urbscore <- list(
    
    print(paste('Full model ANOVA: ', formula(full_model_urbscore)), quote = FALSE),
    print(car::Anova(full_model_urbscore)),
    
    print('Full model R-squared: ', quote = FALSE),
    print(r.squaredGLMM(full_model_urbscore)),
  
    print(paste('Main effects model ANOVA: ', formula(main_effects_model_urbscore)), quote = FALSE),
    print(car::Anova(main_effects_model_urbscore)),
        
    print('Main effects model R-squared: ', quote = FALSE),
    print(r.squaredGLMM(main_effects_model_urbscore)),
    
    cat(sep="\n\n"),
    
    print(paste("AIC (full model) =", AIC(full_model_urbscore)), quote = FALSE),
    print(paste("AIC (main effects model) =", AIC(main_effects_model_urbscore)), quote = FALSE)
      
  )
  
  # make filename a string (from symbol)
  filename1 <- toString(formula(full_model_urbscore)[[2]])

 # export list to csv named for herbivore
  lapply(A_urbscore, function(x) write.table( data.frame(x),
                                              file = paste(filename1, "_ANOVA_urbscore.csv"),
                                              append= T, sep=',' ))
...
Anova_etc <- function(full_model_dist.gradient,
                      ...
                      main_effects_model_urbscore.urbsubs) {
 ...
 # export list to csv named for herbivore
  lapply(A_citydist, function(x) write.table( data.frame(x),
                                              file = paste(filename1, "_ANOVA_dist.csv"),
                                              append= T, sep=',' ))
...
Anova_etc(m1_RL, m1_RL.urb, m1_RL.urb_ME)
```
