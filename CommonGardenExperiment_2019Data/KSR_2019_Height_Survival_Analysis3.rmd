...
## Import data
```{r, import}
Data <- read.csv("~/R_Projects/Chapter2_KSR/CommonGardenExperiment_2019Data/FINAL_3rdmeasuredheight_survival.csv",header=T, na.strings=c("NO PLANT", "none"), blank.lines.skip=TRUE)
